...
const PropertyBar = ({ activeElement, setFormElements }) => {
  ...
  const renderPropertyComponent = () => {
    switch (activeElement.type) {
      ...
      case "tel":
      case "url":
        return <TextProperties activeElement={activeElement}   capitalize={capitalize} handleDone={handleDone}/>;
      case "multiple-checkbox":
        return <CheckboxProperties activeElement={activeElement}   capitalize={capitalize} handleDone={handleDone}/>;
      case "hidden":
        return <HiddenProperties activeElement={activeElement}   capitalize={capitalize} handleDone={handleDone}/>;
      case "textarea":
        return <TextAreaProperties activeElement={activeElement}   capitalize={capitalize} handleDone={handleDone}/>;
      case "date":
        return <DateProperties activeElement={activeElement}   capitalize={capitalize} handleDone={handleDone}/>;
      case "number":
        return <NumberProperties activeElement={activeElement}  capitalize={capitalize} handleDone={handleDone}/>;
      case "select":
        return <SelectProperties activeElement={activeElement} capitalize={capitalize} handleDone={handleDone}/>;
      case "file":
        return <FileUploadProperties activeElement={activeElement} capitalize={capitalize} handleDone={handleDone}/>;
      case "radio":
        return <RadioButtonProperties activeElement={activeElement} capitalize={capitalize} handleDone={handleDone}/>;
      default:
